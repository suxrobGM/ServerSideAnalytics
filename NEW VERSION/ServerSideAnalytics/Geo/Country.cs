        ...
        public static Country World
        {
            get
            {
                return new Country
                {
                    ...
                    CallingCodes =  Array.Empty<string>(),
                    Capital = "",
                    AlternativeSpellings =  Array.Empty<string>(),
                    Region = "",
                    SubRegion = "",
                    Borders =  Array.Empty<CountryCodeIso3>(),
                    Landlocked = false,
                    Area = 510072000,
                };
            }
